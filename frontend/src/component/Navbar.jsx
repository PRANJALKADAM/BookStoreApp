...
function Navbar() {
  const [theme, setTheme] = useState(localStorage.getItem("theme") ? localStorage.getItem("themme") : "light")
  ...
  return (
    <>
      <div className={`max-w-screen-2x1 container mx-auto md:mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white $
          ...
          <div className='navbar-end space-x-3'>
            ...
            <div>
              <label className="swap swap-rotate">
                ...
                <svg className="swap-off fill-current w-8 h-7" 
                ...
                <svg className="swap-on fill-current w-8 h-7"
                 xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  onClick={()=>{
